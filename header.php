...
<nav class="navbar navbar-expand-md navbar-light fixed-top">
		...
		<strong><em>Itali Restaurant</em></strong>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navi">
                <ul class="navbar-nav mr-auto">
                    ...
                    <?php
                    //This is to set the navigation bar when user has logged in
                    ...
                    //To set the navigation bar when user has logged in of the role of admin
                    ...
                    //This is the main page when user have not logged in with the navigation bar
                    else { echo'
                    <li class="nav-item">
	            ...
	            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#footer">Our Location</a>
                    </li>
                    '; } 
                    ?>
                    ...
                    <?php
                    //This is the log out button when user is logged in
    ...
    <!---Sign up form -->
                    <div class="signup-form">
                        <form action="includes/signup.inc.php" method="post">
                            <p class="hint-text">Please create a new account if haven't yet. It's free and only takes a minute.</p>
                            <div class="form-group">
                            ...
                            <div class="text-center">Did you already have an account? <a href="#">Sign in here</a></div>
                    </div> 	
                </div>        
                <!-- Modal footer -->
                <div class="modal-footer">
